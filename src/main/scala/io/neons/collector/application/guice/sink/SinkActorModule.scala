package io.neons.collector.application.guice.sink

import akka.actor.{Actor, ActorRef, ActorSystem}
import com.google.inject.name.{Named, Names}
import com.google.inject.{AbstractModule, Inject, Provides}
import io.neons.collector.application.guice.akka.GuiceAkkaActorRefProvider
import io.neons.collector.application.sink.{ProducerSinkActor, SinkActor}
